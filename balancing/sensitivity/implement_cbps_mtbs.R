...
setwd("~/zfs/projects/faculty/swager-wildfire/wuxiao/wildfire")
...
df = readRDS(paste0(outDir, "/mtbs_analysis_low/analysis_treated", treated.year, "_", area, ".RDS"))
...
saveRDS(res, paste0(outDir, "/mtbs_res_low/res_histfire", treated.year, "_", area, rho ,".RDS"))
gc()
}