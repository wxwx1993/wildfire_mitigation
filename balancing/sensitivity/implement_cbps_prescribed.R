...
for (year_area in 1:nrow(parameters)) {
  ...
  df = readRDS(paste0(outDir, "/prescribed_analysis_low/analysis_treated", treated.year, "_", area, ".RDS"))
  ...
  saveRDS(res, paste0(outDir, "/prescribed_res_low/res_histfire", treated.year, "_", area, rho ,".RDS"))
  gc()
}
